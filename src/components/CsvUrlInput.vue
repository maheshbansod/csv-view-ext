    ...
    <div class="space-y-16">
          ...
          <div class="pl-8">
            ...
            <ul class="space-y-3 text-gray-600">
              ...
              <li class="flex items-center">
                ...
                <a :href="extensionUrl" class="underline hover:text-amber-800" target="_blank">Open source</a>
              </li>
              <li class="flex items-center">
                <svg class="h-5 w-5 text-green-500 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
      ...
      <div class="bg-gradient-to-r from-blue-600 to-blue-800 rounded-xl p-8 text-center text-white">
        ...
        <a
          ...
          target="_blank"
          class="mb-2 inline-flex items-center px-6 py-3 bg-white text-blue-600 rounded-lg font-semibold hover:bg-gray-100 transition-colors"
        >
